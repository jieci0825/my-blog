...
const userTableConfig: JcTableConfig = {
	columns: [
		...
		{ label: '邮箱', property: 'email', width: 240, showOverflowTooltip: true },
		{ label: '登录账号', property: 'account', width: 150, showOverflowTooltip: true },
		{ label: '用户昵称', property: 'nickname', width: 120 },
		{ label: '个性签名', property: 'sign', minWidth: 200, showOverflowTooltip: true },
		{ label: '个人简介', property: 'description', minWidth: 300, showOverflowTooltip: true },
